...
public class ClasseA {
    ...
    private static final metamutator.Selector _binaryLogicalOperatorHotSpot1 = metamutator.Selector.of(11,new spoon.reflect.code.BinaryOperatorKind[]{spoon.reflect.code.BinaryOperatorKind.OR,spoon.reflect.code.BinaryOperatorKind.AND}).in(temporaire.ClasseA.class).id("_binaryLogicalOperatorHotSpot1");

    private static final metamutator.Selector _binaryLogicalOperatorHotSpot2 = metamutator.Selector.of(12,new spoon.reflect.code.BinaryOperatorKind[]{spoon.reflect.code.BinaryOperatorKind.GT,spoon.reflect.code.BinaryOperatorKind.EQ,spoon.reflect.code.BinaryOperatorKind.NE,spoon.reflect.code.BinaryOperatorKind.LT,spoon.reflect.code.BinaryOperatorKind.LE,spoon.reflect.code.BinaryOperatorKind.GE}).in(temporaire.ClasseA.class).id("_binaryLogicalOperatorHotSpot2");

    private static final metamutator.Selector _binaryLogicalOperatorHotSpot3 = metamutator.Selector.of(13,new spoon.reflect.code.BinaryOperatorKind[]{spoon.reflect.code.BinaryOperatorKind.EQ,spoon.reflect.code.BinaryOperatorKind.NE}).in(temporaire.ClasseA.class).id("_binaryLogicalOperatorHotSpot3");
